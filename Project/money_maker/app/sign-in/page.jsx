      ...
      <div className="w-full max-w-md">
        <div className="bg-white border border-gray-200 shadow-lg rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
            ...
            <button
              type="submit"
              className={`bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition-colors mt-4 font-medium flex justify-center ${
                isLoading
            ...
            <p className="text-center mt-2 text-gray-500 text-sm hover:underline cursor-pointer">
